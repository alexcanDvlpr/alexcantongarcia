...
Esta funcionalidad está presente en otros lenguajes de programación como puede ser Java, de esta manera se cubre esa necesidad en JavaScript, ya que en JavaScript podemos asignar a una misma variable distintos valores de distintos tipos, es decir:
