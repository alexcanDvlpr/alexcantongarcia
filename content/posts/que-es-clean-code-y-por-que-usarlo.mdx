...
Esto quiere decir que si un bloque de código, una funció o método estan comentados le dará al programador un contexto de qué es lo que hace ese bloque y una facilidad, por eso **es muy importante escribir buenos comentarios** y por ejemplo en el caso de **JS** podemos añadir un comentario que sirva como la documentación de este, se llama JSDoc, del cual hablaremos en otro post. 
