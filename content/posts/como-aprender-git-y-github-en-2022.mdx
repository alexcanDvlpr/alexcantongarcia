...
date: '2021-12-20'
description: 'Aprende los comandos más básicos de Git, el Control de Versiones más usado de la actualidad. Familiarizate con el sistema creado por Linus Torvals para la gestión de proyectos a nivel de código. Aprende a usar git clone, gi add, git remote, git push, git pull, git commit y git status.'
tags:
    - 'Git'
    - 'GitHub'
---
