...
date: '2021-09-21'
seo_description: 'Tutorial de Desarrollo Web desde 0 en el que creamos un servidor en Node.js (JavaScript) con el framework de Express.js, uno de los más conocidos y minimalistas del mercado. Con un 19.005.088 descargas de media en NPM (Node Package Manager)'
tags:
    - 'JavaScript'
    - 'Node.js'
---
...
Explicado esto, vamos a crear una ruta de acceso (o **endpoint**) para poder acceder a la raiz.
...
Te dejo el enlace del [código del artículo en mi Github](https://github.com/alexcanDvlpr/crear-servidor-node-basico) para que le eches un vistazo al código.