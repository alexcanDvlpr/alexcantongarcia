...
Los objetos son las estructuras de datos "complejas" que usamos para mandar informacion a través de nuestra aplicación. Normalmente los usamos para extrapolar conceptos del mundo real a nuestro código, como por ejemplo, un coche.
...
Esto es porque, aunque haya Strings, Numbers, Boolean etc, casi el 90% de lo que hay en JavaScript son objetos. De hecho cuando se trabaja con JS en el front, el **DOM** (Árbol de componentes del navegador) son objetos, con sus funciones y propiedades.
