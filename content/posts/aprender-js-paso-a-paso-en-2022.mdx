...
A lo largo de estos 27 años, se han ido añadiendo mejoras y modificando el código base, para que el uso de JS se ajuste al gusto de los programadores, a la época y las herramientas en la que se ejecuta hoy en día, y para esto, los desarrolladores nos basamos en unos estándares que marca la evolución de JavaScript.
