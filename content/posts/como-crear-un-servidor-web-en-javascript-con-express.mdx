...
date: '2021-12-16'
description: 'Tutorial de Desarrollo Web desde 0 en el que creamos un servidor web en JavaScript (Node.js) con el framework de Express.js, uno de los más conocidos y minimalistas del mercado. Con un 19.005.088 descargas de media en NPM (Node Package Manager)'
tags:
    - 'JavaScript'
    - 'Nodejs'
---
