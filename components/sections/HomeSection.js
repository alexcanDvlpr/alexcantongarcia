    ...
    return (
        <section className={ styles.homeSectionContent }>
            <div className={ styles.homeTitleContent }>
                ...
                <Text mt={ 2 } className={ styles.homeText } fontSize="md" color="gray.300">Desarrollador web en Madrid, España. Tengo 4 años de experiencia tanto en Backend como en Frontend.
